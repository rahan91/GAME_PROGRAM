...
assert(cut(1, 'easy', 10) === 32, 'perfect easy fast = accuracy weight + 5% time bonus');
  assert(cut(1, 'easy', 999) === 30, 'perfect easy slow = exactly the accuracy weight (no time bonus)');
  assert(cut(1, 'easy', 1000) === 30, 'perfect easy capped at the accuracy weight floor');
  between(cut(1, 'easy', 10), 0, 5000, 'perfect easy bounded 0..5000');
  assert(cut(1, 'insane', 10) === 41, 'perfect insane fast = 30 * 1.30 * 1.05 (no 5000 cap needed)');
  assert(cut(1, 'insane', 999) === 39, 'perfect insane slow = 30 * 1.30');
