...
assert(cut(1, 'easy', 10) === 440, 'perfect easy fast = accuracy weight + 10% time bonus');
assert(cut(1, 'easy', 999) === 400, 'perfect easy slow = exactly the accuracy weight (no time bonus)');
assert(cut(1, 'easy', 1000) === 400, 'perfect easy capped at the accuracy weight floor');
between(cut(1, 'easy', 10), 0, 5000, 'perfect easy bounded 0..5000');
assert(cut(1, 'insane', 10) === 880, 'perfect insane fast = 400 * 2.0 * 1.10 (no 5000 cap needed)');
assert(cut(1, 'insane', 999) === 800, 'perfect insane slow = 400 * 2.0');
