...
assert(cut(1, 'easy', 10) === 3300, 'perfect easy fast = accuracy weight + 10% time bonus');
assert(cut(1, 'easy', 999) === 3000, 'perfect easy slow = exactly the accuracy weight (no time bonus)');
assert(cut(1, 'easy', 1000) === 3000, 'perfect easy capped at the accuracy weight floor');
between(cut(1, 'easy', 10), 0, 5000, 'perfect easy bounded 0..5000');
assert(cut(1, 'insane', 10) === 5000, 'perfect insane hits the 5000 cap');
