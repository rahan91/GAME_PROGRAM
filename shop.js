(function () {
  ...
  var ITEMS = [
    ...
    { key: 'pong:teal',    slot: 'pong', name: 'Teal',    color: '#14b8a6', price: 1000 },
    { key: 'pong:blue',    slot: 'pong', name: 'Blue',    color: '#3b82f6', price: 3000 },
    { key: 'pong:indigo',  slot: 'pong', name: 'Indigo',  color: '#6366f1', price: 4000 },
    { key: 'pong:violet',  slot: 'pong', name: 'Violet',  color: '#8b5cf6', price: 6000 },
    { key: 'pong:red',     slot: 'pong', name: 'Red',     color: '#e5484d', price: 9000 },
    { key: 'pong:orange',  slot: 'pong', name: 'Orange',  color: '#f97316', price: 10000 },
    { key: 'pong:yellow',  slot: 'pong', name: 'Yellow', color: '#FFD700', price: 12000},
    { key: 'pong:gold',    slot: 'pong', name: 'Gold',    color: '#bf9b30', price: 20000 },

    { key: 'tron:default', default: true, slot: 'tron', name: 'Default', color: null, price: 0 },
    { key: 'tron:teal',    slot: 'tron', name: 'Teal',    color: '#14b8a6', price: 750 },
    { key: 'tron:blue',    slot: 'tron', name: 'Blue',    color: '#3b82f6', price: 1200 },
    { key: 'tron:indigo',  slot: 'tron', name: 'Indigo',  color: '#6366f1', price: 1700 },
